...
# Add launchpad.local to /etc/hosts if not present
if ! grep -q "launchpad.local" /etc/hosts; then
    echo "📝 Adding launchpad.local to /etc/hosts (requires sudo)..."
...
echo "   ./scripts/k8s-deploy.sh development"
echo ""
